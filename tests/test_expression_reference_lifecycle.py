...
def test_dormant_expression_holds_input_until_release():
    ...
    expression = Expression(checksum, "", celltype="text", target_celltype="text")
...
def test_equal_expressions_are_registered_and_released_independently():
    ...
    checksum = buffer.get_checksum()
    first = Expression(checksum, "", celltype="text", target_celltype="text")
    second = Expression(checksum, "", celltype="text", target_celltype="text")
    assert first == second
